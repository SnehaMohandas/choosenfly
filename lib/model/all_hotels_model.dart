...
class DatumClass {
  ...
  factory DatumClass.fromJson(Map<String, dynamic> json) => DatumClass(
        ...
        cityId: json["cityId"],
        roomNo: json["roomNo"],
        hotelSearchIwtxResponse: json["hotelSearchIWTXResponse"] == null
            ? null
            : HotelSearchIwtxResponse.fromJson(json["hotelSearchIWTXResponse"]),
        atharvaCityId: json["atharvaCityId"],
        atharvahCode: json["atharvahCode"],
        atharvaTokenId: json["atharvaTokenId"],
        atharvaStarRating: json["atharva_star_rating"],
        ...
        singleIwtxHotelSearchResponse: json["singleIwtxHotelSearchResponse"],
        multiIwtxHotelSearchResponse: json["multiIwtxHotelSearchResponse"],
        jumOwnHotelListDto: json["jumOwnHotelListDTO"] == null
            ? null
            : JumOwnHotelListDto.fromJson(json["jumOwnHotelListDTO"]),
        jumRoomDetails: json["jumRoomDetails"],
        jumeirahError: json["jumeirahError"],
        checkIn: json["checkIn"],
        checkOut: json["checkOut"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "cityId": cityId,
        "roomNo": roomNo,
        "hotelSearchIWTXResponse": hotelSearchIwtxResponse?.toJson(),
        "atharvaCityId": atharvaCityId,
        "atharvahCode": atharvahCode,
        "atharvaTokenId": atharvaTokenId,
        "atharva_star_rating": atharvaStarRating,
        ...
        "singleIwtxHotelSearchResponse": singleIwtxHotelSearchResponse,
        "multiIwtxHotelSearchResponse": multiIwtxHotelSearchResponse,
        "jumOwnHotelListDTO": jumOwnHotelListDto?.toJson(),
        "jumRoomDetails": jumRoomDetails,
        "jumeirahError": jumeirahError,
        "checkIn": checkIn,
        "checkOut": checkOut,
...
class HotelSearchIwtxResponse {
  ...
  factory HotelSearchIwtxResponse.fromJson(Map<String, dynamic> json) =>
      HotelSearchIwtxResponse(
        code: json["Code"],
        name: json["Name"],
...
class JumOwnHotelListDto {
  ...
  bool openForBooking;
  dynamic hotelCode;
  dynamic jumOwnHotelListDtoHotelId;
  dynamic starRating;
  ...
  JumOwnHotelListDto({
    ...
    required this.hotelCode,
    required this.jumOwnHotelListDtoHotelId,
    required this.starRating,
  ...
  factory JumOwnHotelListDto.fromJson(Map<String, dynamic> json) =>
      JumOwnHotelListDto(
        hotelId: json["hotelId"],
        mapperId: json["mapperId"],
        name: json["name"],
        title: json["title"],
        defaultCurrency: defaultCurrencyValues.map[json["default_currency"]]!,
        ...
        hotelCode: json["hotel_code"],
        jumOwnHotelListDtoHotelId: json["hotel_id"],
        starRating: json["star_rating"],
        ratingDescription:
            ratingDescriptionValues.map[json["rating_description"]]!,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "name": name,
        "title": title,
        "default_currency": defaultCurrencyValues.reverse[defaultCurrency],
        "latitude": latitude,
        "longitude": longitude,
        "images": images,
        "videos": videos,
        ...
        "hotel_code": hotelCode,
        "hotel_id": jumOwnHotelListDtoHotelId,
        "star_rating": starRating,
        "rating_description":
            ratingDescriptionValues.reverse[ratingDescription],
        "createdBy": createdBy,
...
final cityValues = EnumValues({"Dubai": City.DUBAI});

enum CountryIsoCode { AE }

final countryIsoCodeValues = EnumValues({"AE": CountryIsoCode.AE});

enum CountryName { UNITED_ARAB_EMIRATES }

final countryNameValues =
    EnumValues({"United Arab Emirates": CountryName.UNITED_ARAB_EMIRATES});

enum DefaultCurrency { AED }

final defaultCurrencyValues = EnumValues({"AED": DefaultCurrency.AED});

enum RatingDescription { EMPTY, SUPERIOR_LUXURY }

final ratingDescriptionValues = EnumValues({
  "": RatingDescription.EMPTY,
  "Superior Luxury": RatingDescription.SUPERIOR_LUXURY
});

enum PlatForm { ATHARVA, INHOUSE, IWTX, JUMEIRAH }

final platFormValues = EnumValues({
  "atharva": PlatForm.ATHARVA,
  "inhouse": PlatForm.INHOUSE,
  "iwtx": PlatForm.IWTX,
  "jumeirah": PlatForm.JUMEIRAH
});
...
enum CurrDate { THE_10012024 }

final currDateValues = EnumValues({"10/01/2024": CurrDate.THE_10012024});

enum Days { WEDNESDAY }

final daysValues = EnumValues({"Wednesday": Days.WEDNESDAY});
...
enum OccupancyType { OCTU, QUAD, SEXT }
