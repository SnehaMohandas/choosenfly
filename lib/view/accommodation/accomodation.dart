      ...
      child: Obx(() {
        if (networkController.isConnected.value) {
          ...
          return Scaffold(
            ...
            body: Obx(
              () => acController.isLoading.value == true
                  ? Center(child: loader())
                  : Form(
                      key: formKey,
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: CustomDropdown.search(
                              initialItem: acController.orgNatCountry.value !=
                                      ""
                              ...
                              items: acController.isLoading.value == true
                                  ? [
                                      Center(
                                        child: Text("Loading..."),
                                      )
                                    ]
                                  : acController.native.map((item) {
                                      return item[0];
                                    }).toList(),
                              ...
                              onChanged: (value) {
                                ...
                                List<dynamic> selectedNative = acController
                                    .native
                          ...
                          Padding(
                            ...
                            child: CustomDropdown.search(
                              initialItem: acController.orgDestination.value !=
                                      ""
                              ...
                              onChanged: (value) {
                                ...
                                List<dynamic> selecteddes = acController
                                    .destination
                                    .firstWhere((item) => item[0] == value);
                                acController.selectedDestinaion.value =
                                    selecteddes[0];
                          ...
                          Padding(
                            ...
                            child: Obx(
                              () => GestureDetector(
                                onTap: () async {
                                  if (acController.selectedNatCountry.value ==
                                      "") {
                                  ...
                                  if (acController.selectedDestinaion.value ==
                                    ...
                                    await acController.postAcDetails();
                                  }
                                },
                                child: Container(
                                  height:
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(10)),
                                  child: Center(
                                    child: acController.isSearchtapped.value ==
                                            false
                                        ? const Text("Search",
                                            style: TextStyle(
                                                color: ColorConstant.white,
                                              ...
                                              Get.to(
                                                  () => RoomDetails2(
                                                        ...
                                                        roomCount: acController
                                                            .newRoomCount.value,
                                                        adultCount: acController
                                                            .adultDdnum,
                                                        childCount: acController
                                                            .childDdnum,
