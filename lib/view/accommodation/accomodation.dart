...
// import 'package:choose_n_fly/view/accommodation/dup_guestdtail.dart';
...
class AccommodationScreen extends StatelessWidget {
    ...
    return WillPopScope(
      ...
      child: Obx(() {
        if (networkController.isConnected.value) {
          ...
          print("accccloaddingg==>${acController.isLoading.value}");
  ...
  orgValueadded(AccomodationController acController) {
    ...
    acController.orgNativeCode.value = acController.selectedNativeCode.value;
    acController.orgNativeCode2.value = acController.selectedNativeCode2.value;
    ...
    acController.atharvaroomDetailOrg = acController.atharvaroomDetail;
    acController.iwtxRoomdetailOrg = acController.iwtxRoomdetail;
    acController.iwtxAgedetailOrg = acController.iwtxageDetail;
  }
}
