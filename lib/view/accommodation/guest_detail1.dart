...
class GuestDetail1 extends StatelessWidget {
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          children: [
                                  ...
                                  () => Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        DropdownButtonFormField<String>(
                                            value: acController.adultDdnum.value
                                                            .length ==
                                                        0 ||
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Obx(
                                        () => DropdownButtonFormField<String>(
                                            value: acController.childDdnum.value
                                                            .length ==
                                                        0 ||
                                            ...
                                            onChanged: (newValue) {
                                              acController.selectedChildIndex
                            ...
                            Obx(() => acController.selectedChildIndex.value ==
                                        index.toString() ||
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              print("sum of guests ${acController.guestTotal}");
                              print(
                              ...
                              for (int i = 0;
                                  i <
                                      int.parse(acController.roomCount.value
                                          .toString());
                                  i++) {
                                mappedAges = acController.ageTextControllers[i]
                                    .map((e) => e.text)
                                    .toList();
  ...
  List<Map<String, dynamic>> getEnteredData(
    ...
    var length =
        acController.roomCount.value != "" ? acController.roomCount.value : 1;

    for (int i = 0; i < int.parse(length.toString()); i++) {
      Map<String, dynamic> data = {
        "room no": acController.roomCount.value != ""
            ? (i + 1).toString()
            : 0.toString(),
        'adult': acController.adultDdnum[i] != 0
            ? acController.adultDdnum[i]
            : 0.toString(),
        'children': acController.childDdnum[i] == 0
            ? 0.toString()
