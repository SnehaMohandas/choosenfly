                ...
                () => DropdownButtonFormField<String>(
                    ...
                    onChanged: (newValue) {
                      ...
                      for (int i = 0;
                          i <
                              int.parse(
                                  roomController.roomCount.value.toString());
                          i++) {
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Column(
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Obx(
                                        () => DropdownButtonFormField<String>(
                                            ...
                                            onChanged: (newValue) {
                                              roomController.adultDdnum[index] =
                                                  newValue;
                                            }),
                                      ),
                                    ],
                                    ...
                                    children: [
                                      ...
                                      Obx(
                                        () => DropdownButtonFormField<String>(
                                            ...
                                            onChanged: (newValue) {
                                              roomController.selectedChildIndex
                                              ...
                                              roomController.childDdnum[index] =
                                                  newValue;
                            ...
                            Obx(() => roomController.selectedChildIndex.value ==
                                        index.toString() ||
                                          ...
                                          gridDelegate:
                                              SliverGridDelegateWithFixedCrossAxisCount(
                                                  ...
                                                  mainAxisExtent: roomController
                                                      ...
                                                      : 50,
                                                  mainAxisSpacing: 10),
                                          itemCount: int.parse(roomController
                                              .childDdnum[index]
                                              .toString()),
                                          shrinkWrap: true,
                                          physics: BouncingScrollPhysics(),
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              num adultSum = roomController.adultDdnum.fold(0,
                                  (previous, current) {
                                if (current is num) {
                              ...
                              print('Sum of the list: ${adultSum.toString()}');
                              num childSum = roomController.childDdnum.fold(0,
                                  (previous, current) {
                                if (current is num) {
                                  return previous + current;
                                } else if (current is String) {
                              ...
                              print('Sum of the list: ${childSum.toString()}');
                              ...
                              var childorglist =
                                  getEnteredData(acController, roomController);
                              print(childorglist);
    ...
    for (int i = 0; i < int.parse(length.toString()); i++) {
      ...
      Map<String, dynamic> data = {
        ...
        if (roomController.allAgeOrgs[i].isNotEmpty)
          "children age": roomController.allAgeOrgs[i].join(', ')
